...
{
    update();
    std::cout << strMeshPath.toStdString() << std::endl;
    QString filename = strMeshPath + "/../screenshot/" + QDateTime::currentDateTime().toString("yyyyMMddHHmmsszzz") + QString(".png");
...
void MeshViewerWidget::DrawFlat(void) const
{
    ...
    for (const auto& fh : mesh.faces())
    {
        ...
        for (const auto& fvh : mesh.fv_cw_range(fh))
        {
